...
namespace ModernAppliances
{
    ...
    internal class MyModernAppliances : ModernAppliances
    {
        ...
        {
            // <summary>
            // write command for input
            // ask for input with conversion from string to long
            // save input to variable
            // >summary>
            Console.WriteLine("Enter the item number of an appliance: ");
            long appliance_number_input = Convert.ToInt64(Console.ReadLine());
            Appliance? foundAppliance = null;
            foreach (Appliance appliance in Appliances) 
            {
                if (appliance.ItemNumber == appliance_number_input);
                {
